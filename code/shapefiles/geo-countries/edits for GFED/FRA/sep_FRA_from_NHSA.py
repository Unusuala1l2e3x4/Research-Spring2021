...
areas = {'FRA-NHSA':copy.deepcopy(temp)}

areas['FRA-NHSA']['features'][0]['properties']['ADMIN'] = 'France NHSA'


areas['FRA-NHSA']['features'][0]['properties']['id'] = 'FRA-NHSA'
...
for polygon in polygons:
  ...
  if lat < 8 and lat > 0 and lon > -56 and lon < -50:
    loc = 'FRA-NHSA'
  else:
    continue
