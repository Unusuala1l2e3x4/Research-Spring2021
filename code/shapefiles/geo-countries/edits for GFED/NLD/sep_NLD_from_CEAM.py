...
areas = {'NLD-CEAM':copy.deepcopy(temp)}

areas['NLD-CEAM']['features'][0]['properties']['ADMIN'] = 'NLDnce CEAM'


areas['NLD-CEAM']['features'][0]['properties']['id'] = 'NLD-CEAM'
